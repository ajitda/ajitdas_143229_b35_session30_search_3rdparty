                ...
                <div class="form-bottom">
                    <form role="form" action="store.php" method="post" class="login-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="book_title" placeholder="Book Title..." class="form-booktitle form-control" id="form-booktitle">
                        </div>
                        <div class="form-group">
                            <label class="sr-only" for="form-author">Author Name</label>
                            <input type="text" name="author_name" placeholder="Author Name..." class="form-author form-control" id="form-author">
                        </div>
