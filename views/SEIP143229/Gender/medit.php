                ...
                <div class="form-bottom">
                    <form role="form" action="update.php" method="post" class="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" name="gender" value="Male" id="your-gender" <?php if($oneData->gender=='Male') echo 'checked'; ?>> Male
                            <input type="radio" name="gender" value="Female" id="your-gender" <?php if($oneData->gender=='Female') echo 'checked'; ?>> Female
                            <input type="radio" name="gender" value="Other" id="your-gender" <?php if($oneData->gender=='Other') echo 'checked'; ?>> Other<br><br>
                        </div>
